...
<span data-animation="fadeInLeft" data-delay="0.1s">kentaro ono</span>
<h1 data-animation="fadeInLeft" data-delay="0.4s">���쌒���Y</h1>
...
<p>You窶冤l look at graphs and charts in Task One, how to approach the task and <br> the language needed for a successful answer.</p>
...
<p>You窶冤l look at graphs and charts in Task One, how to approach the task </p>
</div>
...
<p>You窶冤l look at graphs and charts in Task One, how to approach the task and the language needed 
for a successful answer. You窶冤l examine Task Two questions and learn how to plan, write and 
check academic essays.</p>
<p class="mb-40">Task One, how to approach the task and the language needed for a successful answer. You窶冤l 
...
<div class="features-caption">
<h3>Location</h3>
<p>You窶冤l look at graphs and charts in Task One, how to approach </p>
</div>
</div>
</div>
